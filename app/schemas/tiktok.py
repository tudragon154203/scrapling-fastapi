...
class TikTokSessionConfig(BaseModel):
    ...
    user_data_master_dir: str = Field(default="./user_data/master", description="Master user data directory")
    user_data_clones_dir: str = Field(default="./user_data/clones", description="Cloned user data directory")
