"""Camoufox-based TikTok download strategy using StealthyFetcher."""
...
class CamoufoxDownloadStrategy(TikTokDownloadStrategy):
    """TikTok download strategy using Camoufox with StealthyFetcher."""
    ...
    def resolve_video_url(self, tiktok_url: str, quality_hint: Optional[str] = None, force_headful: bool = False) -> str:
        """
        Resolve the direct MP4 URL for a TikTok video using TikVid with Camoufox.

        Args:
            tiktok_url: The TikTok video URL to resolve
            quality_hint: Optional quality preference (HD, SD, etc.)
            force_headful: Whether to force headful mode (ignored for camoufox)
    ...
    async def resolve_video_url_async(self, tiktok_url: str, quality_hint: Optional[str] = None, force_headful: bool = False) -> str:
        """
        Resolve the direct MP4 URL for a TikTok video using TikVid with Camoufox asynchronously.
